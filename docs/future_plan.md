...
> **Moved to Implementation Plan.** Auto-rebase has been formalized as Phase 9E in `docs/IMPLEMENTATION_PLAN.md`. See that document for the full specification including scenarios, UX, and task references (REBASE-001 through REBASE-007).
