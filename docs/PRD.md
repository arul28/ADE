...
- **Apps**: `apps/desktop/` (Electron main + preload + renderer), `apps/ade-cli/` (headless ADE CLI action server), `apps/ade-code/` (terminal Ink client for Work chat), `apps/web/` (marketing), `apps/ios/` (companion).
