...
denies unbound and elevated callers, ignores forged scope, and never exposes
the renderer-only profile diagnostics or permission-administration actions.
