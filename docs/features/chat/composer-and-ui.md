...
| `InstructionErrorCard.tsx` | Compact failed-turn instruction card. Host-emitted `errorInfo.presentation` supplies title, body, next action, and folded technical details + Copy. The row never titles itself Error or Unknown. |
