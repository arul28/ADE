...
machine clears attachments and machine-owned tool context. Browser, App Control,
and iOS panels also fail closed when their local-only service cannot safely
operate on the chat's owning runtime.
