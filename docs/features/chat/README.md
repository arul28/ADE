...
| `apps/desktop/src/renderer/lib/visualContextFormatting.ts` | Serializes iOS, Electron Control, built-in browser, and attachment context into prompt text. |
...
- **Built-in browser.** The main process owns a persistent
  ...
  chips alongside iOS / Electron Control selections.
