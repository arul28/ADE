...
| `/info` | Open Chat Info for the active chat: plan, goal, tasks, PR rollup, and subagents. |
...
| `/pr open` | Create or open a PR for the active lane. |
