...
Confidence scoring, queue evaluation, sandbox cwd checks, and secret resolution all run in the ADE runtime that owns the project — the renderer just edits and observes the gates.
