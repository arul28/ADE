---
title: "Settings"
description: "Reference for every section in ADE Settings — General, Appearance, Workspace, AI, Mobile Push, Integrations, Lane Templates, and Usage."
icon: "sliders"
---
...
<Note>
Sync uses cr-sqlite for CRDT replication. Missions, lanes, and session history all replicate. `.ade/artifacts/` blobs are fetched on demand by the requesting device.
</Note>
