...
<Info>Screenshot needed: The .ade/ directory expanded in a file tree showing ade.yaml, local.yaml, local.secret.yaml, and subdirectories.</Info>
...
<Info>Screenshot needed: The config approval dialog showing a diff view of ade.yaml changes with Approve and Reject buttons.</Info>
...
<Info>Screenshot needed: The Settings panel showing the three config files, the Approved SHA display, and the Re-approve button.</Info>
