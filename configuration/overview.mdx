...
<Frame caption=".ade/ file tree — ade.yaml, local files, and subdirectories">
  <img
    src="/images/ade-directory-file-tree-config-files.png"
    alt="The .ade/ directory expanded in a file tree showing ade.yaml, local.yaml, local.secret.yaml, and subdirectories."
  />
</Frame>
...
<Frame caption="Config approval dialog — ade.yaml diff with Approve and Reject">
  <img
    src="/images/config-approval-dialog-ade-yaml-diff-buttons.png"
    alt="The config approval dialog showing a diff view of ade.yaml changes with Approve and Reject buttons."
  />
</Frame>
...
<Frame caption="Settings — three config files, approved SHA, and Re-approve">
  <img
    src="/images/settings-config-files-approved-sha-reapprove.png"
    alt="The Settings panel showing the three config files, the Approved SHA display, and the Re-approve button."
  />
</Frame>
