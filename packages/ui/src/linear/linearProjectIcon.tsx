...
export function LinearProjectIcon({
  ...
  if (glyph) {
    return (
      <span
        className="grid shrink-0 place-items-center rounded-[4px] leading-none ade-linear-project-icon"
        style={{
          width: size,
          height: size,
  ...
  return (
    <span
      className="grid shrink-0 place-items-center rounded-[4px] text-[9px] font-semibold text-white/90 ade-linear-project-icon ade-linear-project-icon-initial"
      style={{
        width: size,
        height: size,
