...
description: "Secure your automations with tool palette restrictions, budget caps, and preflight controls. Covers agent-session, mission, and built-in-task execution."
icon: "shield-check"
---
