...
<CardGroup cols={2}>
  <Card title="Daily Agent Brief" icon="message">
    ...
    **Execution:** Agent session.
    ...
    Summarizes repo activity since the last weekday brief — commits, PRs, missions, and risk signals — in an automation-only chat thread. Pulls repo state and procedures as context.
  </Card>
...
| Tool palette | ADE CLI domains the agent can use (repo, git, github, linear, mission, tests) |
