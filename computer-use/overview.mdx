...
description: "Proof is ADE's intentional evidence system. Agents capture screenshots, recordings, traces, and logs via the `ade proof` CLI; ADE stores and links them to worker runs, chats, PRs, and Linear issues."
icon: "camera"
---
...
| Pull Requests | Proofs routed to a PR appear in the PR detail view as inline attachments |
