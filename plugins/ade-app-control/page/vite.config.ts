 ...
 *
 * - `base: "./"` — the guest loads from `ade-plugin://ade-app-control/dist/index.html`,
 ...
 * (`ade-plugin://ade-app-control/…`) by ADE's protocol handler, which answers no
