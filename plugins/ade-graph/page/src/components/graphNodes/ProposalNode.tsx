/**
 * A proposed integration that has no lane yet.
 *
 * Ported from `components/graph/graphNodes/ProposalNode.tsx`, unchanged except
 * for the `cn` import moving to `@ade-dev/ui`.
 */
...
import { proposalOutcomeColor } from "../../lib/graphHelpers";
