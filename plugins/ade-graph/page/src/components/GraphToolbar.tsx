/**
 * The canvas header: search, filters, and reset.
 *
 * View-mode tabs, the overlap-web toggle, the pair matrix, and the mode caption
 * were removed — the canvas is one stacked DAG. Filters stay in an overlay so
...
import type { GraphFilterState, GraphStatusFilter, LaneSummary } from "../lib/types";
import { activeGraphFilterCount } from "../lib/graphHelpers";
