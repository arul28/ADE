...
<Frame caption="ADE's workspace with multiple lanes running agents in parallel">
  <img src="/images/hero-workspace.png" alt="ADE workspace overview showing lanes, agents, and the workspace graph" />
</Frame>
...
<Frame caption="Demo: Creating a lane and launching an agent in under 30 seconds">
  <img src="/images/demo-create-lane.gif" alt="Animated demo of creating a lane and starting an agent chat" />
</Frame>
...
<Frame caption="ADE's sidebar navigation — each tab maps to a section in these docs">
  <img src="/images/app-sidebar.png" alt="ADE sidebar showing Run, Lanes, Work, Files, Graph, PRs, History, Automations, Missions, CTO, and Settings tabs" />
</Frame>
