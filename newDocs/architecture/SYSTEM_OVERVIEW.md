...
| `fileService` | `fileService.ts` | Atomic file writes within lane worktrees |
...
Communication between the renderer and main process is organized into 71 IPC channels spanning 13 subsystems:
...
| Files | `ade.files.*` | 1 | invoke/handle |
