...
<Frame caption="Chat header context meter ~65% with Compact now tooltip">
  <img
    src="/images/chat-context-meter-compact-now-tooltip.png"
    alt={`Context meter in the chat header — show it at ~65% capacity with the "Compact now" suggestion tooltip visible.`}
  />
</Frame>
