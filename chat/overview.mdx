...
description: "Conversational AI with real project access — read files, run commands, create PRs, spawn worker runs, and capture proof artifacts, all from a single chat interface."
icon: "comments"
---
## What is Agent Chat?
