...
<Info>**Screenshot: PR creation flow in chat — show the agent's message proposing a PR, the pre-filled PR form with auto-generated title and description, and the "Create PR" confirm button.</Info>
