...
**Tool calls**: The agent reads files, writes code, and runs commands using ADE's MCP tools. Each tool call appears as an expandable block in the chat. You do not need to grant per-call permissions in the default configuration.
