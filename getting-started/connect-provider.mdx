...
<Tabs>
  ...
  <Tab title="CLI-based providers">
    ...
    <Note>
    Local CLIs and SDK-backed providers are checked during onboarding and on each app launch. If you install a CLI or add a provider key after starting ADE, open **Settings** and select **AI Providers**, then click **Refresh** to re-detect.
    </Note>
  </Tab>
</Tabs>
