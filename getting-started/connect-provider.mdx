...
<Frame caption="Settings → AI showing provider cards with connection status">
  <img src="/images/settings-ai-providers.png" alt="AI Providers settings panel showing Anthropic, OpenAI, and Cursor cards" />
</Frame>
...
<Tabs>
  ...
  <Tab title="CLI-based providers">
    ...
    <Note>
    CLI-based providers are detected during onboarding and on each app launch. If you install a CLI after starting ADE, go to **Settings → AI** and click **Refresh** to re-detect.
    </Note>
  </Tab>
</Tabs>
