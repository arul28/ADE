...
<CardGroup cols={2}>
  <Card title="Computer use is browser-only" icon="camera">
    Native OS screenshot, video, and GUI automation are unavailable. Electron Control over CDP, the built-in browser, and attaching proof files with `ade proof attach` all work.
  </Card>
