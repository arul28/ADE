...
<Frame caption="A completed mission showing the plan, worker progress, and collected artifacts">
  <img src="/images/guide-mission-overview.png" alt="Mission detail view with completed steps and artifacts" />
</Frame>
