...
<Frame caption="Automations panel showing active rules with trigger types and run history">
  <img src="/images/guide-automations.png" alt="Automations Rules tab with configured PR review and test runner rules" />
</Frame>
