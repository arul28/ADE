...
<Frame caption="A 3-deep stacked PR chain visualized in ADE's Workspace Graph">
  <img src="/images/guide-stacked-prs-graph.png" alt="Workspace graph showing a chain of stacked lanes with PR badges" />
</Frame>
