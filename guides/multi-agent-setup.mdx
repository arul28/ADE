...
- Proof artifacts and logs are attached to the lane, PR, or automation run that produced them
...
| 8+ | Split work across named lanes, cap concurrent agents, and monitor total token spend in Settings > Usage. |
