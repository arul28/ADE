...
<Frame caption="Four lanes with active agents running in parallel, monitored from the Workspace Graph">
  <img src="/images/guide-multi-agent.png" alt="Workspace graph showing four active lanes with agent activity indicators" />
</Frame>
