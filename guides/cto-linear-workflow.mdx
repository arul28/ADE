---
title: "Guide: CTO + Linear workflow"
sidebarTitle: "CTO + Linear Workflow"
...
<Frame caption="CTO agent triaging a Linear issue and spawning a worker to handle it">
  <img src="/images/guide-cto-linear.png" alt="CTO chat showing Linear issue triage with worker delegation" />
</Frame>
...
| `worker_run` | Tasks that need a dedicated lane but not full mission structure |
| `mission` | Complex multi-step work requiring planning, validation, and audit |
