...
<Steps>
  ...
  <Step title="Complete the onboarding wizard">
    ...
    <Info>**Screenshot: The CTO onboarding wizard on step 2 ("Project Scanning") — showing a progress indicator with items being checked off: "Reading repository structure ✓", "Analyzing recent commits ✓", "Loading existing packs... (in progress)", "Connecting to Linear (skipped)".</Info>
  </Step>
