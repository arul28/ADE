...
<Frame caption="CTO tab — Chat, Team, Memory, Linear, and Settings sub-tabs with active chat thread">
  <img src="/images/cto-overview.png" alt="CTO tab with Chat selected showing a conversation thread and status panel" />
</Frame>
...
<Frame caption="CTO Team sub-tab — workers with lane, status, specialization, and budget">
  <img
    src="/images/cto-team-sub-tab-workers-org-chart.png"
    alt="The Team sub-tab showing an org chart or card grid of workers with name, specialization, assigned lane, status indicator, and budget usage."
  />
</Frame>
