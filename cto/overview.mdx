...
<CardGroup cols={2}>
  ...
  <Card title="Project Awareness" icon="diagram-project">
    Uses current lane, PR, Linear, mission, and repository context to make delegation decisions.
  </Card>
</CardGroup>
...
| **Context** | Project, lane, PR, Linear, and mission state | Current session or assigned lane |
