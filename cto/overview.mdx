...
<Info>Screenshot: The CTO tab main view showing the five sub-tabs (Chat, Team, Memory, Linear, Settings) with Chat selected, the CTO status panel on the left, and an active chat thread on the right.</Info>
...
<Info>Screenshot: The Team sub-tab showing an org chart or card grid of workers with name, specialization, assigned lane, status indicator, and budget usage.</Info>
