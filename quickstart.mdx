...
<Steps>
  <Step title="Install ADE">
    On macOS, download the latest DMG from [GitHub Releases](https://github.com/arul28/ADE/releases/latest), open it, and drag **ADE.app** into `/Applications`. On Windows 10/11 x64, ADE is in beta and installs with a per-user installer that needs no administrator rights — see [ADE on Windows](/getting-started/windows). Install the optional iOS companion from [TestFlight](https://testflight.apple.com/join/ZSdJGKPy).
  </Step>
