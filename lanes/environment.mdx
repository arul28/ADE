...
<Info>**Screenshot:** Lane detail header showing a preview URL badge (e.g., "http://auth-refactor.localhost:3001") next to the branch name, with a green "Running" indicator and a clickable external link icon.</Info>
