...
The intent section tells agents what this lane exists to accomplish. ADE generates an initial intent from the branch name and early commits, but refine it to be specific.
