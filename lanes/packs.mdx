...
<Info>**Screenshot:** The Packs sub-tab in the right inspector, showing a Lane Pack with labeled sections: intent at the top, criteria as a bulleted list, touched files as a compact file list, and a diff summary paragraph. Show a "Regenerate" button and a pack freshness timestamp in the header.</Info>
