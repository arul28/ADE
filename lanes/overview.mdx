...
<Frame caption="The Lanes tab — 3-pane layout with lane list, diff view, and inspector">
  <img src="/images/lanes-overview.png" alt="Lanes tab showing lane list sidebar, diff view in center, and inspector panel on right" />
</Frame>
...
<Frame caption="Lanes tab — annotated 3-pane layout (list, detail, inspector)">
  <img
    src="/images/lanes-tab-annotated-three-pane-layout.png"
    alt="Annotated 3-pane layout diagram showing the lane list, lane detail pane, and right inspector with sub-tabs."
  />
</Frame>
