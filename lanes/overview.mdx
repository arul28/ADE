...
<Info>Screenshot: The full Lanes tab in 3-pane layout showing the lane list, lane detail with diff view, and the inspector pane.</Info>
...
<Info>Screenshot: Annotated 3-pane layout diagram showing the lane list, lane detail pane, and right inspector with sub-tabs.</Info>
