...
<Steps>
  ...
  <Step title="Choose a name and base branch">
    ...
    <Info>**Screenshot:** The "New Lane" dialog, showing the lane name field, base branch dropdown (with `main` selected), lane type selector (Worktree highlighted), and the "Advanced" section collapsed at the bottom.</Info>
  </Step>
