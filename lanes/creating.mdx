...
<Steps>
  ...
  <Step title="Choose a name and base branch">
    ...
    <Frame caption="New Lane dialog — name, base branch, Worktree type, Advanced collapsed">
      <img
        src="/images/new-lane-dialog-base-branch-worktree.png"
        alt={`The "New Lane" dialog, showing the lane name field, base branch dropdown (with \`main\` selected), lane type selector (Worktree highlighted), and the "Advanced" section collapsed at the bottom.`}
      />
    </Frame>
  </Step>
