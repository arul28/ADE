...
The History view is ADE's complete operations ledger — every agent action, commit, pack regeneration, mission phase, conflict, and PR event, timestamped with full operational context. It is the single place where you can answer: "What exactly happened in this project over the last two days?"
