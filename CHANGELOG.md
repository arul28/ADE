...
- Fixed packaged desktop Cursor SDK worker startup by resolving the worker through the packaged Node path and seeding x64 Cursor SDK and canvas payloads for universal macOS packaging.
