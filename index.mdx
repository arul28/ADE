...
description: "Orchestrate parallel AI coding agents from a unified desktop control plane. Lanes, worker runs, context packs, and conflict detection — all local-first."
---
