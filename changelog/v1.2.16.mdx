...
- **Packaged Cursor SDK startup.** Installed desktop builds now resolve the Cursor SDK worker through the packaged Node path, and universal macOS packaging now seeds and permits the arch-specific native payloads needed for Intel updates, including native addons compiled during install.
