...
export const BUILTIN_COMMANDS: BuiltinCommand[] = [
  ...
  { name: "/plugin", description: "List Claude plugins, or list Codex plugins (read-only)", placement: "right", argumentHint: "[reload|native args]", providers: ["claude", "codex"], category: "Model" },
