...
export const BUILTIN_COMMANDS: BuiltinCommand[] = [
  ...
  { name: "/chat settle", description: "Move the active session into the settled tier", placement: "right", argumentHint: "[outcome]", category: "Chats" },
  { name: "/chat unsettle", description: "Return the active session to the active lifecycle", placement: "right", category: "Chats" },
