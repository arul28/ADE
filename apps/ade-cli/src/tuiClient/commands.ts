...
export const BUILTIN_COMMANDS: BuiltinCommand[] = [
  ...
  { name: "/chat rename", description: "Rename the active chat", placement: "right", argumentHint: "[title]" },
  { name: "/chat archive", description: "Archive the active chat", placement: "right" },
  { name: "/chat unarchive", description: "Unarchive a chat by id or title", placement: "right", argumentHint: "<chat-id|title>" },
  { name: "/chat archived", description: "List archived chats", placement: "right", argumentHint: "[filter]" },
  { name: "/chat delete", description: "Delete the active chat after confirmation", placement: "right" },
  ...
  { name: "/context", description: "Show chat context usage", placement: "right" },
  { name: "/agents", description: "List Claude agents from user and project config", placement: "right", providers: ["claude"] },
  { name: "/info", description: "Open active chat info, plan, goal, and agents", placement: "right" },
  { name: "/skills", description: "List agent skills from project, user, and ADE bundled roots", placement: "right" },
  ...
  { name: "/goal", description: "Set, clear, or inspect the active chat goal", placement: "chat", argumentHint: "[<text>|clear|status active|paused|complete]", providers: ["claude", "codex"] },
  ...
  { name: "/lane rename", description: "Rename the active lane", placement: "right", argumentHint: "[name]" },
  { name: "/lane archive", description: "Archive the active lane", placement: "right" },
  { name: "/lane unarchive", description: "Unarchive a lane by id or name", placement: "right", argumentHint: "<lane-id|name>" },
  { name: "/lane archived", description: "List archived lanes", placement: "right" },
  { name: "/lane delete", description: "Delete the active lane after confirmation", placement: "right" },
  ...
  { name: "/pr comment", description: "Comment on the active PR", placement: "right", argumentHint: "<text>" },
  { name: "/pr approve", description: "Approve the active PR", placement: "right", argumentHint: "[note]" },
  { name: "/pr request-changes", description: "Request changes on the active PR", placement: "right", argumentHint: "<text>" },
  { name: "/pr land", description: "Merge the active PR (needs confirm)", placement: "right", argumentHint: "[confirm] [merge|squash|rebase]" },
  ...
  { name: "/chats", description: "List chats in the active lane", placement: "right", argumentHint: "[filter]" },
  ...
  { name: "/keybindings", description: "Show Claude-compatible keybinding config diagnostics", placement: "right", argumentHint: "[open]" },
  ...
  { name: "/effort", description: "Open the reasoning-effort picker", placement: "right" },
