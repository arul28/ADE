...
const PROVIDER_MARKS: Record<string, ProviderMark> = {
  ...
  qwen: { label: "Qwen", short: "Qw", terminal: "Qw", color: "#615CED", svgPath: QWEN_PATH },
  copilot: { label: "GitHub Copilot", short: "GH", terminal: "GH", color: "#F0F0F2", iconFill: "#000000", svgPath: GITHUB_COPILOT_PATH },
  githubcopilot: { label: "GitHub Copilot", short: "GH", terminal: "GH", color: "#F0F0F2", iconFill: "#000000", svgPath: GITHUB_COPILOT_PATH },
  github: { label: "GitHub Copilot", short: "GH", terminal: "GH", color: "#F0F0F2", iconFill: "#000000", svgPath: GITHUB_COPILOT_PATH },
...
const ROW_MARKS: Record<string, ProviderMark> = {
  ...
  qwen: PROVIDER_MARKS.qwen!,
  copilot: PROVIDER_MARKS.copilot!,
  githubcopilot: PROVIDER_MARKS.githubcopilot!,
  github: PROVIDER_MARKS.github!,
