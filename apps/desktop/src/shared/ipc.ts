export const IPC = {
  ...
  storageRunMaintenanceNow: "ade.storage.runMaintenanceNow",
  ...
  attentionNotchSettingsChanged: "ade.attentionNotch.settingsChanged",
  ...
  analyticsSetEnabled: "ade.analytics.setEnabled",
  ...
  remoteRuntimeGetHandoffStoragePreflight: "ade.remoteRuntime.getHandoffStoragePreflight",
  ...
  runtimeEventsRelease: "ade.runtime.events.release",
  ...
  lanesGetBranchDrift: "ade.lanes.getBranchDrift",
  lanesResolveBranchDrift: "ade.lanes.resolveBranchDrift",
  ...
  lanesArchiveAndReclaim: "ade.lanes.archiveAndReclaim",
  lanesUnarchive: "ade.lanes.unarchive",
  ...
  sessionsSnooze: "ade.sessions.snooze",
  sessionsWake: "ade.sessions.wake",
  ...
  agentChatPromptStashesCreate: "ade.agentChat.promptStashes.create",
  agentChatPromptStashesDelete: "ade.agentChat.promptStashes.delete",
  agentChatHandoff: "ade.agentChat.handoff",
  agentChatPrepareCrossMachineHandoff: "ade.agentChat.prepareCrossMachineHandoff",
  ...
  agentChatResolveUnprocessedMessage: "ade.agentChat.resolveUnprocessedMessage",
  ...
  agentChatRegenerateSessionMetadata: "ade.agentChat.regenerateSessionMetadata",
  agentChatCreateScheduledWork: "ade.agentChat.scheduledWork.create",
  ...
  agentChatCopyTempAttachment: "ade.agentChat.copyTempAttachment",
  ...
  computerUseListBrokenArtifacts: "ade.computerUse.listBrokenArtifacts",
  computerUsePruneBrokenArtifacts: "ade.computerUse.pruneBrokenArtifacts",
  ...
  iosSimulatorRetainWindowParking: "ade.iosSimulator.retainWindowParking",
  iosSimulatorReleaseWindowParking: "ade.iosSimulator.releaseWindowParking",
  iosSimulatorOpenSystemSettings: "ade.iosSimulator.openSystemSettings",
  iosSimulatorRevealWindow: "ade.iosSimulator.revealWindow",
  ...
  iosSimulatorOpenDevice: "ade.iosSimulator.openDevice",
  iosSimulatorCloseDevice: "ade.iosSimulator.closeDevice",
  iosSimulatorGetDeviceSettings: "ade.iosSimulator.getDeviceSettings",
  iosSimulatorSetAppearance: "ade.iosSimulator.setAppearance",
  iosSimulatorSetContentSize: "ade.iosSimulator.setContentSize",
  iosSimulatorSetAccessibilityOption: "ade.iosSimulator.setAccessibilityOption",
  iosSimulatorSetLocation: "ade.iosSimulator.setLocation",
  iosSimulatorClearLocation: "ade.iosSimulator.clearLocation",
  iosSimulatorSetPermission: "ade.iosSimulator.setPermission",
  iosSimulatorSendPushNotification: "ade.iosSimulator.sendPushNotification",
  iosSimulatorOpenUrl: "ade.iosSimulator.openUrl",
  iosSimulatorRelaunchApp: "ade.iosSimulator.relaunchApp",
  iosSimulatorTerminateApp: "ade.iosSimulator.terminateApp",
  iosSimulatorUninstallApp: "ade.iosSimulator.uninstallApp",
  ...
  iosSimulatorFindElement: "ade.iosSimulator.findElement",
  iosSimulatorTapElement: "ade.iosSimulator.tapElement",
  iosSimulatorFillElement: "ade.iosSimulator.fillElement",
  iosSimulatorWaitForElement: "ade.iosSimulator.waitForElement",
  ...
  aiPiLoginSubmit: "ade.ai.piLoginSubmit",
  aiPiLoginCancel: "ade.ai.piLoginCancel",
  aiPiAuthStatus: "ade.ai.piAuthStatus",
  aiCursorAuthStatus: "ade.ai.cursorAuthStatus",
  aiCursorAuthLogin: "ade.ai.cursorAuthLogin",
  aiCursorAuthLogout: "ade.ai.cursorAuthLogout",
  aiCursorAuthCancel: "ade.ai.cursorAuthCancel",
  aiCursorAuthEvent: "ade.ai.cursorAuthEvent",
  aiGetToolsCache: "ade.ai.getToolsCache",
  aiEnsureToolsCache: "ade.ai.ensureToolsCache",
  aiToolsCacheEvent: "ade.ai.toolsCacheEvent",
  ...
  projectSecretsExportEnv: "ade.projectSecrets.exportEnv",
  ...
  aiCursorCloudGetLaneSecretNames: "ade.ai.cursorCloud.getLaneSecretNames",
  ...
  aiDevinCloudFleet: "ade.ai.devinCloud.fleet",
  aiDevinCloudPullIntoLane: "ade.ai.devinCloud.pullIntoLane",
  aiDevinCloudOpenChat: "ade.ai.devinCloud.openChat",
  aiDevinCloudWatchMirror: "ade.ai.devinCloud.watchMirror",
  aiDevinCloudFollowUp: "ade.ai.devinCloud.followUp",
  aiDevinCloudCreateSession: "ade.ai.devinCloud.createSession",
  aiDevinCloudTerminateSession: "ade.ai.devinCloud.terminateSession",
  aiDevinCloudArchiveSession: "ade.ai.devinCloud.archiveSession",
  ...
  accountStartLogin: "ade.account.startLogin",
  accountPollLogin: "ade.account.pollLogin",
  accountCancelLogin: "ade.account.cancelLogin",
  accountStartDeviceLogin: "ade.account.startDeviceLogin",
  accountPollDeviceLogin: "ade.account.pollDeviceLogin",
  ...
  prsListGitHubStacks: "ade.prs.listGitHubStacks",
  prsSyncGitHubStacks: "ade.prs.syncGitHubStacks",
  prsCreateGitHubStack: "ade.prs.createGitHubStack",
  prsAddGitHubStackPullRequests: "ade.prs.addGitHubStackPullRequests",
  prsUnstackGitHubStack: "ade.prs.unstackGitHubStack",
  ...
  prsGetDetailBundle: "ade.prs.getDetailBundle",
