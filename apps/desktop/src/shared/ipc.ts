export const IPC = {
  ...
  pluginList: "ade.plugin.list",
  pluginGet: "ade.plugin.get",
  pluginGetPanel: "ade.plugin.getPanel",
  pluginGetCollection: "ade.plugin.getCollection",
  pluginInvoke: "ade.plugin.invoke",
  pluginInstall: "ade.plugin.install",
  pluginUninstall: "ade.plugin.uninstall",
  pluginEnable: "ade.plugin.enable",
  pluginDisable: "ade.plugin.disable",
  pluginUsageSummary: "ade.plugin.usageSummary",
  pluginSetConfig: "ade.plugin.setConfig",
  pluginSetContributionEnabled: "ade.plugin.setContributionEnabled",
  pluginMarketplaceIndex: "ade.plugin.marketplaceIndex",
  pluginRepoStars: "ade.plugin.repoStars",
  pluginPresence: "ade.plugin.presence",
  pluginGetReadme: "ade.plugin.getReadme",
  pluginGetManifest: "ade.plugin.getManifest",
  pluginOpenLogs: "ade.plugin.openLogs",
  ...
  githubGetRepoStarState: "ade.github.getRepoStarState",
  githubSetRepoStarred: "ade.github.setRepoStarred",
