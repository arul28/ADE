...
export function createLanesNamespace(infra: AdapterInfra): AdeNamespace<"lanes"> {
  ...
  const lanes: Record<string, unknown> = {
    ...
    attachGitHubIssueToSession: (args: unknown) => call("lane.attachGitHubIssueToSession", args, [], false),
    detachGitHubIssueFromSession: (args: unknown) => call("lane.detachGitHubIssueFromSession", args, false, false),
    listGitHubIssuesForSession: (args: unknown) => call("lane.listGitHubIssuesForSession", args, []),
    listGitHubIssuesForLaneSessions: (args: unknown) => call("lane.listGitHubIssuesForLaneSessions", args, []),
