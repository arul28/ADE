  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/3 z-50 w-[min(400px,calc(100vw-24px))] -translate-x-1/2 -translate-y-1/2 rounded bg-card border border-border/40 p-3 shadow-float focus:outline-none">
