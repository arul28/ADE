  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 6, minHeight: 20 }}>
        ...
        {/* Contributed badges stay in the left-flowing badge group: everything after
            this claims the free space with `marginLeft: auto` and would push them to
            the far right, away from the ADE badges they belong beside. */}
