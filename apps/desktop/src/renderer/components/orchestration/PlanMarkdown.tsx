 ...
 *     `artifacts/ui/*.html`      with an "Open in ADE browser" button)
...
export type PlanMarkdownProps = {
  ...
  /**
   * Bundle root (for "Open in ADE browser" URL composition when the asset
...
function MermaidBlock({ source }: { source: string }) {
  ...
  return (
    <div
      ...
      // eslint-disable-next-line react/no-danger -- mermaid output is rendered with strict security level
