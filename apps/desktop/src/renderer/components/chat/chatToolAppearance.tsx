...
const TOOL_META: Record<string, ToolMeta> = {
  ...
  TaskCreate: { label: "Create Task", icon: ListChecks, badgeCls: "border-violet-400/25 bg-violet-400/12 text-violet-200", category: "plan", sourceTone: "accent", getTarget: a => String(a.subject ?? a.description ?? "") || null },
  TaskGet: { label: "Get Task", icon: ListChecks, badgeCls: "border-cyan-400/25 bg-cyan-400/12 text-cyan-200", category: "read", sourceTone: "info", getTarget: a => String(a.taskId ?? "") || null },
  TaskUpdate: { label: "Update Task", icon: ListChecks, badgeCls: "border-violet-400/25 bg-violet-400/12 text-violet-200", category: "plan", sourceTone: "accent", getTarget: a => String(a.subject ?? a.description ?? a.taskId ?? "") || null },
  TaskList: { label: "List Tasks", icon: ListChecks, badgeCls: "border-cyan-400/25 bg-cyan-400/12 text-cyan-200", category: "read", sourceTone: "info" },
  REPL: { label: "REPL", icon: Terminal, badgeCls: "border-amber-400/25 bg-amber-400/12 text-amber-200", category: "exec", sourceTone: "warning", getTarget: a => String(a.description ?? "") || null },
  Workflow: { label: "Workflow", icon: Strategy, badgeCls: "border-violet-400/25 bg-violet-400/12 text-violet-200", category: "meta", sourceTone: "accent", getTarget: a => String(a.name ?? a.description ?? "") || null },
  CronCreate: { label: "Schedule", icon: ListChecks, badgeCls: "border-cyan-400/25 bg-cyan-400/12 text-cyan-200", category: "meta", sourceTone: "info", getTarget: a => String(a.cron ?? "") || null },
  CronDelete: { label: "Delete Schedule", icon: StopCircle, badgeCls: "border-red-400/25 bg-red-500/12 text-red-200", category: "meta", sourceTone: "warning", getTarget: a => String(a.id ?? "") || null },
  CronList: { label: "List Schedules", icon: ListBullets, badgeCls: "border-cyan-400/25 bg-cyan-400/12 text-cyan-200", category: "read", sourceTone: "info" },
  ScheduleWakeup: { label: "Wake Later", icon: ListChecks, badgeCls: "border-cyan-400/25 bg-cyan-400/12 text-cyan-200", category: "meta", sourceTone: "info", getTarget: a => String(a.reason ?? a.prompt ?? "") || null },
  Monitor: { label: "Monitor", icon: Cpu, badgeCls: "border-amber-400/25 bg-amber-400/12 text-amber-200", category: "exec", sourceTone: "warning", getTarget: a => String(a.description ?? a.command ?? "") || null },
  ...
  EnterWorktree: { label: "Enter Worktree", icon: FolderOpen, badgeCls: "border-violet-400/25 bg-violet-400/12 text-violet-200", category: "meta", sourceTone: "accent", getTarget: a => String(a.name ?? a.path ?? "") || null },
