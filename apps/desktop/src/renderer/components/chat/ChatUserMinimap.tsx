...
export function ChatUserMinimap({ displayEntries, activeDisplayIndex, onJumpToRow }: ChatUserMinimapProps) {
  ...
  return (
    <div
      className="pointer-events-none absolute right-3 top-3 z-20 flex flex-col items-end"
      role="region"
