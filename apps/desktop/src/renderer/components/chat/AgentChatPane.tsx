...
export function AgentChatPane({
  ...
  }, [buildNativeControlPayload, composerExecutionTargetId, composerExecutionTargetLabel, currentNativeControls, laneId, modelId, notifySessionCreated, reasoningEffort, refreshSessions, touchSession]);
