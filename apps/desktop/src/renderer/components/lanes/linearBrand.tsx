...
/** Canonical Linear logo path (24×24). Single source for LinearMark and any
 *  imperative renderer (e.g. the composer smart-link chip). */
export const LINEAR_LOGO_PATH =
