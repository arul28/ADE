/**
 * RichMarkdown — the document-grade markdown renderer behind the Files tab's
 * markdown preview.
 *
 * Sibling to ChatMarkdown but with richer behaviour tuned for document content:
 *   • ```mermaid fences        → lazy-loaded mermaid diagram render
 *   • images                   → embedded inline, max-width clamped
...
export function RichMarkdown({
  ...
  const components = useMemo(
    () => buildComponents({ onSectionClick }),
    [onSectionClick],
  );
  ...
  return (
    ...
    >
      <ReactMarkdown
        ...
        rehypePlugins={[rehypeRaw, [rehypeSanitize, markdownSanitizeSchema], rehypeSectionAnchors]}
