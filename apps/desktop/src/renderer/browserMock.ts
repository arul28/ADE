...
if (typeof window !== "undefined" && shouldInstallBrowserMock(window)) {
  ...
  (window as any).ade = {
    ...
    macosVm: {
      getStatus: resolvedArg({
        ...
        activeProvider: {
          ...
          available: false,
          version: null,
          detail: "Browser preview does not run local Apple Virtualization helpers.",
          docsUrl: "https://developer.apple.com/documentation/virtualization/virtualize-macos-on-a-mac",
        },
        tools: [],
        laneVm: null,
        vms: [],
      ...
      createBase: resolvedArg({} as any),
      startBase: resolvedArg({} as any),
      stopBase: resolvedArg(null),
      markBaseReady: resolvedArg({} as any),
      deleteBase: resolvedArg({ deleted: false, previous: null }),
      renameBase: resolvedArg({} as any),
      saveLaneVmAsSnapshot: resolvedArg({} as any),
      clearIpswCache: resolvedArg({ cleared: true, path: "", bytesFreed: 0 }),
      ...
      getAgentGuide: resolvedArg({
        ...
        target: {
          ...
          runCommand: "ade --socket macos-vm start --lane lane-main --create --text",
          sshCommand: null,
          vncUrl: null,
    ...
    git: {
      ...
      discardFiles: resolvedArg({ ok: true }),
      restoreStagedFile: resolvedArg({ ok: true }),
      restoreStagedFiles: resolvedArg({ ok: true }),
