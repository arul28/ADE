...
if (typeof window !== "undefined" && shouldInstallBrowserMock(window)) {
  ...
  (window as any).ade = {
    ...
    ai: {
      ...
      devinCloudGetAuthStatus: resolved({
        configured: true,
        authMode: "v3",
        orgId: "org-demo",
        orgName: "Demo Org",
      ...
      devinCloudSetCredentials: resolvedArg(undefined),
      devinCloudFleet: resolved({
        ...
        items: [
          {
            session: {
              ...
              isArchived: false,
              url: "https://app.devin.ai/sessions/demo-session-running",
              pullRequests: [],
              tags: [],
              repos: ["ade-demo/ade"],
          ...
          },
          {
            session: {
              ...
              isArchived: false,
              url: "https://app.devin.ai/sessions/demo-session-blocked",
              pullRequests: [],
              tags: ["ade", "ade:lane:demo-lane"],
              repos: ["ade-demo/ade"],
            ...
            fleetStatus: "needs_you",
            prUrl: null,
            ownership: { sessionId: null, sessionTitle: null, laneId: "demo-lane", laneName: "demo-lane", linearIssueId: null },
            createdViaAde: true,
            adeLaneId: "demo-lane",
            matchedBy: "tag",
          },
          {
            session: {
              ...
              title: "Add retry to sync backoff",
              status: "finished",
              statusDetail: "finished",
              isArchived: false,
              url: "https://app.devin.ai/sessions/demo-session-done",
              pullRequests: [{ prUrl: "https://github.com/ade-demo/ade/pull/882", prState: "open" }],
              tags: ["ade"],
              repos: ["ade-demo/ade"],
              createdAt: Date.now() - 26 * 3_600_000,
              updatedAt: Date.now() - 20 * 3_600_000,
              devinMode: "normal",
              acusConsumed: 0.8,
              userId: "user-demo",
              parentSessionId: null,
            ...
            fleetStatus: "finished",
            prUrl: "https://github.com/ade-demo/ade/pull/882",
            ownership: { sessionId: null, sessionTitle: null, laneId: null, laneName: null, linearIssueId: null },
            createdViaAde: true,
            adeLaneId: null,
            matchedBy: "tag",
      ...
      devinCloudPullIntoLane: resolvedArg({
        status: "pulled",
        laneId: "demo-lane",
        laneName: "demo-lane",
        sessionId: null,
        mergedBranch: "devin/demo-branch",
      } as any),
      devinCloudTerminateSession: resolvedArg(undefined),
      devinCloudArchiveSession: resolvedArg(undefined),
      devinCloudUnarchiveSession: resolvedArg(undefined),
      devinCloudFollowUp: resolvedArg(undefined),
