...
export function getModelCapabilities(): GetModelCapabilitiesResult {
  const profiles: ModelCapabilityProfile[] = [
    ...
    },
    {
      ...
      modelId: "gpt-5.5",
      displayName: "GPT-5.5",
      strengths: ["frontier coding", "complex implementation", "testing", "code review"],
      weaknesses: ["higher latency", "not needed for simple edits"],
      costTier: "high",
    ...
    },
    {
      ...
      modelId: "gpt-5.4",
      displayName: "GPT-5.4",
      strengths: ["strong implementation", "reliable coding tasks", "test writing"],
      weaknesses: ["less capable than GPT-5.5 on complex tasks"],
      costTier: "high",
    ...
    },
    {
      ...
      strengths: ["fast coding", "quick edits", "lower-cost iteration"],
      weaknesses: ["less capable than GPT-5.5 on complex multi-file refactors"],
      costTier: "low",
      bestFor: ["implementation"],
      parallelCapable: true,
      reasoningTiers: ["low", "medium", "high", "xhigh"]
