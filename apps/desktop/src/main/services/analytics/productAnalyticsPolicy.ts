...
const ANALYTICS_ONLY_ACTIONS = new Set([
  ...
  "auto_sent",
  // Which of the Work tools pane's tools an installation actually opens. The
  // pane is a picker plus one active tool, and `ade_screen_viewed` "work" only
...
const SAFE_STRING_VALUES: Partial<Record<string, ReadonlySet<string>>> = {
  screen: new Set([
    "project", "hub", "lanes", "files", "work", "prs", "review", "history", "automations",
