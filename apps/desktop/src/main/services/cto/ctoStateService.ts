...
function buildCtoEnvironmentKnowledge(): string {
  ...
  "  - Example: 'Launch a chat with opus' → spawnChat({ modelId: 'anthropic/claude-opus-5', ... }). 'Open a terminal' → createTerminal. 'Run npm test' → createTerminal({ startupCommand: 'npm test' }).",
  "",
  ...
  "  'Resolve merge conflicts' → getConflictStatus, then work the conflicting files.",
