...
function buildCtoEnvironmentKnowledge(): string {
  ...
  "",
  "Path to Merge: ADE's PR-merge automation — launches a visible chat agent that watches a PR and drives it to merge itself (fixes CI failures, addresses review comments, runs the merge ladder).",
  "  - Runs as a real chat session in the Work tab; the user can open, watch, and redirect it.",
  "  - Launched from the PR detail panel or the Queue's Automate Merging flow, not via a CTO tool.",
  "",
  ...
  "  /prs — Pull request management: list, detail view, Path to Merge, queue, GitHub integration.",
  ...
  "  6. If issues: launch Path to Merge from the PR detail panel to have a visible agent drive it to merge.",
