...
const CTO_CAPABILITY_MANIFEST = [
  ...
  "",
  "## Events & Health",
  "  getRecentEvents — Unified feed of recent project events (sessions, worker activity, tests, PRs, chats). Params: since, limit.",
  "  getProjectHealthSummary — Aggregate dashboard: worker utilization, test pass rates, PR status, budget burn.",
  "",
  "## Computer Use",
