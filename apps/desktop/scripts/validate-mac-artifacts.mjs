...
async function validatePackagedRuntime(appPath, description) {
  ...
  const macosVmHelperRoot = path.join(resourcesPath, "native", "macos-vm-helper");
  ...
  await assertPathExists(macosVmHelperBuildScript, "bundled macOS VM helper build script");
  await assertPathExists(path.join(macosVmHelperRoot, "entitlements.plist"), "bundled macOS VM helper entitlements");
  await assertPathExists(path.join(macosVmHelperRoot, "macos-vm-helper.swift"), "bundled macOS VM helper source");
  await assertPathMissing(path.join(macosVmHelperRoot, "build"), "bundled macOS VM helper build cache");
  ...
  await assertExecutable(macosVmHelperBuildScript, "bundled macOS VM helper build script");
