...
- Touch ID WebAuthn remains disabled unless `ADE_ENABLE_TOUCH_ID_WEBAUTHN=1` is set and the signed app has the matching keychain access-group entitlement. Do not describe it as iCloud-synced passkey support.
